...
class InspectorProvider {
    ...
    parse_variable(va, object_id) {
        ...
        let child_props = [];
        if (value) {
            let sub_variables = typeof value["sub_values"] === "function" && value instanceof variants_1.ObjectId === false
                ? value.sub_values()
                : Array.isArray(value)
                    ? value.map((va, i) => {
                    ...
                    : value instanceof Map
                        ...
                        : [];
            child_props = (_a = sub_variables) === null || _a === void 0 ? void 0 : _a.map((va) => {
