...
class Mediator {
    ...
    static notify(event, parameters = []) {
        ...
        switch (event) {
            ...
            case "stop":
                ...
                (_1 = this.session) === null || _1 === void 0 ? void 0 : _1.sendEvent(new vscode_debugadapter_1.TerminatedEvent(false));
                break;
            case "error":
                (_2 = this.controller) === null || _2 === void 0 ? void 0 : _2.set_exception(parameters[0]);
                (_3 = this.controller) === null || _3 === void 0 ? void 0 : _3.stop();
                (_4 = this.session) === null || _4 === void 0 ? void 0 : _4.sendEvent(new vscode_debugadapter_1.TerminatedEvent(false));
                break;
        }
    }
    ...
    static build_sub_values(va) {
        ...
        (_a = sub_values) === null || _a === void 0 ? void 0 : _a.forEach((sva) => this.build_sub_values(sva));
    }
